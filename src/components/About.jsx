          ...
          <div className="grid gap-2 justify-items-center lg:justify-items-start">
            <div className="grid gap-4 max-w-2xl">
              <p className="text-dark leading-relaxed text-justify lg:text-left">
                <span className="text-primary text-xl font-semibold">Olá, eu sou Michely</span>, e é um prazer receber você no meu espaço. Minha paixão pelo toque terapêutico e pelo poder de cura do corpo me levou a Massoterapia há mais de 5 anos, e tenho dedicado a minha carreira a ajudar as pessoas a encontrarem alívio, bem estar e equilíbrio em meio a correria do dia a dia. Aprofundei-me em diversas técnicas, desde as tradicionais até as mais modernas, para oferecer o melhor aos meus clientes.
              </p>
              <p className="text-dark leading-relaxed text-justify lg:text-left">
