  ...
  return (
    <>
      ...
      <div className='container mx-auto px-4'>
        <h1 className='text-4xl md:text-5xl font-bold text-primary mb-5'>Bem-estar e relaxamento <br /> Para seu corpo e sua mente</h1>
        <p className='text-lg text-dark max-w-2xl mx-auto mb-8'>
          Descubra os benefícios da massoterapia com uma profissional especializada e transforme sua qualidade de vida.
        </p>
